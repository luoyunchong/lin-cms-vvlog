              ...
              <el-popover placement="top-start" width="360" trigger="hover">
                <el-card shadow="never" style="border:none;" :body-style="{ padding: '10px' }">
                  ...
                  <div class="user-card__meta">
                    ...
                    <div class="user-card__info" v-if="item.introduction">{{item.introduction}}</div>
                    <div class="user-card__info" v-else-if="item.create_time!=0">
                      <span class="ft-gray">{{item.create_time|filterTime}}</span>
                      加入
                    </div>
                    <div class="user-card__info" v-if="item.last_login_time!=0">
                      最后登录
                      <span class="ft-gray">{{item.last_login_time|filterTimeYmdHms}}</span>
                    </div>
                  </div>
                </el-card>
                <el-avatar
