...
| loading | 当卡片内容还在加载中时，可以用 `loading` 展示一个占位 | boolean\|[object](https://vue.ant.design/component/spin-cn/#API) | false |
| loadMore | 加载更多 | string\|slot | - |
| locale | 默认文案设置，目前包括空数据文案 | object | emptyText: '暂无数据' |
| pagination | 对应的 `pagination` [配置](https://element.eleme.cn/#/zh-CN/component/pagination#slot), 设置 `false` 不显示 | boolean\|object | false |
...
| 参数     | 说明               | 类型                        | 默认值   |
| -------- | ------------------ | --------------------------- | -------- |
| position | 指定分页显示的位置 | 'top' \| 'bottom' | 'bottom' |

更多配置项，请查看 [`Pagination`](https://vue.ant.design/component/pagination-cn/#API)。
